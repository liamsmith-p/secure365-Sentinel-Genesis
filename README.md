...
> **Microsoft Entra ID sign-in and audit logs** cannot be configured via ARM deployment. After deployment, go to **Sentinel > Data connectors > Microsoft Entra ID** and connect it manually — this takes about 30 seconds.
